...
- **Day 25 — Jeopardy & the villain:** danger, loss, feuds, a kith who turns; the village responds. **Now also carries realm-borne catastrophe (pillar 11):** realm-keyed deterministic disasters (tsunami/avalanche/eruption/quake/drought/flood/wildfire) with warning→strike→aftermath phases the mind reacts to; and the 3-Body chaotic-seasons realm. (May split across Day 25 + a Day 25b if it proves large — the disaster engine plus per-realm tuning is a lot; ship the framework + 2–3 disasters first, add the rest and the chaos-realm after.)
